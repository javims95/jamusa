...
// Consulta 
$resultado = $conexion->query("select * from blog where nombre_pagina= '$url'") or die($conexion->error);
...
<head>
    <meta charset="utf-8">
    <title><?php echo $datos[7] ?></title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="<?php echo $datos[8] ?>">
    <meta name="keywords" content="<?php echo $datos[9] ?>">
                ...
                <div class="col-md-8">
                    <div class="post-box">
                        <div class="post-thumb">
                            <input type="hidden" value="<?php echo $datos[0] ?>">
                            <img src="img/post-1.jpg" class="img-fluid" alt="">
                        </div>
                        <div class="post-meta">
                            <h1 class="article-title"><?php echo $datos[1] ?></h1>
                            <ul>
                                <li>
                                    <span class="ion-ios-person"></span>
                                    <a href="#"><?php echo fechaEsp($fecha) ?></a>
                                </li>
                                <li>
